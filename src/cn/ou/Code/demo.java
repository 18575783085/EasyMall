...
public class demo {
    ...
    static final String accessKeyId = "LTAIU2iaYwQ6bA2W";
    static final String accessKeySecret = "Ay0G6aXFsBmyLEjB8kHGW2KjyRXzV5";
    ...
    public static SendSmsResponse sendSms(String phone) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("业哥测试");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_101095028");
